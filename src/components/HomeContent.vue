  ...
  <div id="home-content">
    <div class="catchcopy">
      <div class="catchcopy_content">
        ...
        <div class="btn_login">
          <b-button @click="googleLogin">今すぐ利用する</b-button>
        </div>
      </div>
    </div>
    <div class="columns">
      <div class="column">
        <div class="card">
          <header class="card-header card-header-title-base">
          ...
          <div class="card-content">
            <div class="content">
              グループ単位でメンバーを管理できます。選択したグループはログインユーザ毎に保持されます。
            </div>
          </div>
        </div>
      </div>
      <div class="column">
        <div class="card">
          ...
          <div class="card-content">
            <div class="content">
              メンバーの情報(名前/役職/電話番号)を新規登録できます。UI上から修正や削除もできます。
            </div>
          </div>
        </div>
      </div>
      <div class="column">
        <div class="card">
          ...
          <div class="card-content">
            <div class="content">
              メンバーの行き先や補足情報を変更できます。メンバーを複数選択して変更することもできます。
            </div>
          </div>
        </div>
      </div>
...
.catchcopy_content h1{
  font-size : 45px;
  font-weight : bold;
  text-shadow: 0px 0px 10px #000000;
}
.catchcopy_content h2{
  margin-bottom: 20px;
}
.columns{
  margin-top: 20px;
}
.catchcopy_content button{
  opacity : 1.0;
